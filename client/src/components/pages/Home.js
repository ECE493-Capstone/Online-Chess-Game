...
const Home = () => {
  ...
  return (
    <Header>
      ...
      >
        <div className="standard" style={{ position: "absolute", top: "50%", left: "50%", transform: "translate(-50%, -50%)", padding: "20px", borderRadius: "8px", maxWidth: "90%" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", padding: "2em", width: "90%", maxWidth: "400px"}}>
            <TextField
              id="room-code"
              label="Room Code"
              variant="outlined"
